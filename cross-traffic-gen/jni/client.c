...
JNIEXPORT void JNICALL Java_com_example_crosstraffic_CrossTraffic_runClient( JNIEnv* env, jobject thiz,jstring destIp, jstring port)
{
...
//        //fprintf(logFileHandle, "Just after asserting \n");
        ...
        /* This is background traffic, so it has to keep running */ 
