 ...
 */
package com.example.crosstraffic;
...
public class CrossTraffic extends Activity
{
    ...
    public void onButtonClicked(View v) {
        // Do something when the button is clicked
          Toast.makeText(CrossTraffic.this, "Running UDP ping", Toast.LENGTH_SHORT).show();
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        destIP.setText("18.251.6.223");
        
        destPort = (EditText) findViewById(R.id.destPort);
        destPort.setText("1026");
     ...
     * /data/data/com.example.crosstraffic/lib/... at
